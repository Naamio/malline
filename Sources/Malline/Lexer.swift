struct Lexer {
    let stencilString: String
    
    init(stencilString: String) {
        self.stencilString = stencilString
    }
    ...
    /// Returns an array of tokens from a given stencil string.
    func tokenize() -> [Token] {
        var tokens: [Token] = []
        
        let scanner = Scanner(stencilString)
